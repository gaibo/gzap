...
cdx_ig_rate = Index(bbg_data['IBOXUMAE CBBT Curncy', 'PX_LAST']/100, 'CDX NA IG (Rate)')
vixig = VolatilityIndex(creditvix_data['VIXIG', 'CreditVix_pc'], cdx_ig_normalized, 'VIXIG')
vixig_bp = VolatilityIndex(creditvix_data['VIXIG', 'CreditVix_bp'], cdx_ig_rate, 'BP VIXIG')
cdx_hy = Index(bbg_data['IBOXHYSE CBBT Curncy', 'PX_LAST'], 'CDX NA HY')    # Not scaled; need historical spreads
cdx_hy_rate = Index(bbg_data['IBOXHYSE CBBT Curncy', 'PX_LAST']/100, 'CDX NA HY (Rate)')
vixhy = VolatilityIndex(creditvix_data['VIXHY', 'CreditVix_pc'], cdx_hy, 'VIXHY')
vixhy_bp = VolatilityIndex(creditvix_data['VIXHY', 'CreditVix_bp'], cdx_hy_rate, 'BP VIXHY')
itraxx_ie_normalized = Index(scaled_cds_index_data['iTraxx EU Main'], 'iTraxx EU Main (Normalized)')
itraxx_ie_rate = Index(bbg_data['ITRXEBE CBBT Curncy', 'PX_LAST']/100, 'iTraxx EU Main (Rate)')
vixie = VolatilityIndex(creditvix_data['VIXIE', 'CreditVix_pc'], itraxx_ie_normalized, 'VIXIE')
vixie_bp = VolatilityIndex(creditvix_data['VIXIE', 'CreditVix_bp'], itraxx_ie_rate, 'BP VIXIE')
itraxx_xo_normalized = Index(scaled_cds_index_data['iTraxx EU Xover'], 'iTraxx EU Xover (Normalized)')
itraxx_xo_rate = Index(bbg_data['ITRXEXE CBBT Curncy', 'PX_LAST']/100, 'iTraxx EU Xover (Rate)')
vixxo = VolatilityIndex(creditvix_data['VIXXO', 'CreditVix_pc'], itraxx_xo_normalized, 'VIXXO')
vixxo_bp = VolatilityIndex(creditvix_data['VIXXO', 'CreditVix_bp'], itraxx_xo_rate, 'BP VIXXO')
itraxx_fs_normalized = Index(scaled_cds_index_data['iTraxx EU SenFin'], 'iTraxx EU SenFin (Normalized)')
itraxx_fs_rate = Index(bbg_data['ITRXESE CBBT Curncy', 'PX_LAST']/100, 'iTraxx EU SenFin (Rate)')
vixfs = VolatilityIndex(creditvix_data['VIXFS', 'CreditVix_pc'], itraxx_fs_normalized, 'VIXFS')
vixfs_bp = VolatilityIndex(creditvix_data['VIXFS', 'CreditVix_bp'], itraxx_fs_rate, 'BP VIXFS')
