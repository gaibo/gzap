...
vixig = VolatilityIndex(creditvix_data['VIXIG', 'CreditVix_pc'], cdx_ig, 'VIXIG')
...
vixie = VolatilityIndex(creditvix_data['VIXIE', 'CreditVix_pc'], itraxx_ie, 'VIXIE')
...
vixxo = VolatilityIndex(creditvix_data['VIXXO', 'CreditVix_pc'], itraxx_xo, 'VIXXO')
...
vixfs = VolatilityIndex(creditvix_data['VIXFS', 'CreditVix_pc'], itraxx_fs, 'VIXFS')
